...
public class RobotMap {
    ...
    public static DoubleSolenoid pincersPincerActuator;
    public static DoubleSolenoid pincersPincerElevatorActuator;
    public static SpeedController plaidapaultWinchMoter;
    public static DoubleSolenoid plaidapaultTriggerActuator;
    public static DoubleSolenoid plaidapaultStopActuator;
    ...
    public static void init() {
        ...
        pincersPincerMotor = new Talon(1, 5);
	LiveWindow.addActuator("Pincers", "PincerMotor", (Talon) pincersPincerMotor);
        
        pincersPincerActuator = new DoubleSolenoid(1, 1, 2);      
	
        
        pincersPincerElevatorActuator = new DoubleSolenoid(1, 3, 4);      
	
        
        plaidapaultWinchMoter = new Victor(1, 6);
	LiveWindow.addActuator("Plaidapault", "WinchMoter", (Victor) plaidapaultWinchMoter);
        
        plaidapaultTriggerActuator = new DoubleSolenoid(1, 5, 6);      
	
        
        plaidapaultStopActuator = new DoubleSolenoid(1, 7, 8);      
