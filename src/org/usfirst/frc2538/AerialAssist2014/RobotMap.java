...
public class RobotMap {
    ...
    public static DoubleSolenoid pincersElevatorActuator;
    public static SpeedController plaidapultWinchMoter;
    ...
    public static void init() {
        ...
        pincersSwivelMotor = new Talon(1, 5);
	LiveWindow.addActuator("Pincers", "SwivelMotor", (Talon) pincersSwivelMotor);
        
        pincersArmActuator = new DoubleSolenoid(1, 1, 2);      
	
        
        pincersElevatorActuator = new DoubleSolenoid(1, 3, 4);      
	
        
        plaidapultWinchMoter = new Victor(1, 6);
	LiveWindow.addActuator("Plaidapult", "WinchMoter", (Victor) plaidapultWinchMoter);
